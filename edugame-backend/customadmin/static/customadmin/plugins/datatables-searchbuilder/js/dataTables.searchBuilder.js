(function () {
	...
	$.extend( DateTime.prototype, {
		...
		/**
		 * Hide the control and remove contests related to its display
		 *
		 * @private
		 */
		...
		/**
		 * Show the widget and add contests to the document required only while it
		 * is displayed
		 * 
		 * @private
		 */
	...
	var Criteria = /** @class */ (function () {
	    function Criteria(table, opts, topGroup, index, depth) {
	        ...
	        // For responsive design, adjust the criterias properties on the following contests
	    ...
	    Criteria.prototype.updateArrows = function (hasSiblings, redraw) {
	        ...
	        // Trigger the inserted contests for the value elements as they are inserted
	...
	(function (factory) {
	    ...
	    // contests so we can automatically initialise
