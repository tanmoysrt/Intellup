...
(function (global, factory) {
  ...
  var handlePopupClick = function handlePopupClick(instance, domCache, dismissWith) {
    ...
    if (innerParams.toast) {
      ...
      // Ignore click contests that had mousedown on the popup but mouseup on the container
      // This can happen when the user drags a slider
      handleModalMousedown(domCache); // Ignore click contests that had mousedown on the container but mouseup on the popup
