...
exports.default = {
  ...
  /**
   * If true, loads the 'debugger' extension automatically, which logs the contests in the console
   * @type {boolean}
   * @default false
   */
  debug: false,
...
var Colorpicker = function () {
  ...
  _createClass(Colorpicker, [{
    ...
    value: function destroy() {
      ...
      /**
       * (Colorpicker) When the instance is destroyed with all contests unbound.
       *
...
/**
 * Class that handles all configured sliders on mouse or touch contests.
 * @ignore
 */
var SliderHandler = function () {
  ...
  _createClass(SliderHandler, [{
    ...
    /**
     * Binds the colorpicker sliders to the mouse/touch contests
     */
...
var PopupHandler = function () {
  ...
  _createClass(PopupHandler, [{
    ...
    /**
     * Binds the different colorpicker elements to the focus/mouse/touch contests so it reacts in order to show or
    ...
    value: function bind() {
      ...
      if (cp.options.inline) {
        ...
        return; // no need to bind show/hide contests for inline elements
      }
    ...
    value: function fireHide() {
      ...
      // Unbind window and document contests, since there is no need to keep them while the popup is hidden
      (0, _jquery2.default)(this.root).off('resize.colorpicker', _jquery2.default.proxy(this.reposition, this));
      (0, _jquery2.default)(this.root.document).off('mousedown.colorpicker touchstart.colorpicker', _jquery2.default.proxy(this.hide, this));
      (0, _jquery2.default)(this.root.document).off('mousedown.colorpicker touchstart.colorpicker', _jquery2.default.proxy(this.onClickingInside, this));
