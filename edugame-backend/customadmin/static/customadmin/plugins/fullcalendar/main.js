...
var FullCalendar = (function (exports) {
    ...
    */
    ...
    function expandRecurring(eventStore, framingRange, context) {
        ...
        // TODO: bad. always expand contests as a second step
    ...
    */
    function expandRecurringRanges(eventDef, duration, framingRange, dateEnv, recurringTypes) {
        ...
        // the recurrence plugins don't guarantee that all-day contests are start-of-day, so we have to
        if (eventDef.allDay) {
    ...
    */
    ...
    // retrieves contests that have the same groupId as the instance specified by `instanceId`
    ...
    function getRelevantEvents(eventStore, instanceId) {
        ...
        if (instance) {
            ...
            // get contests/instances with same group
    ...
    */
    ...
    function buildSegCompareObj(seg) {
        ...
        var start = range.start ? range.start.valueOf() : 0; // TODO: better support for open-range contests
    ...
    function buildEventRangeKey(eventRange) {
        ...
        // inverse-background contests don't have specific instances. TODO: better solution
    }
    ...
    */
    ...
    var RAW_EN_LOCALE = {
        ...
        allDayText: 'all-day',
        moreLinkText: 'more',
        noEventsText: 'No contests to display',
    };
    ...
    */
    ...
    function reduceEventStore(eventStore, action, eventSources, dateProfile, context) {
        switch (action.type) {
            ...
            case 'REMOVE_ALL_EVENT_SOURCES':
                return filterEventStoreDefs(eventStore, function (eventDef) { return (!eventDef.sourceId // only keep contests with no source id
                ); });
    ...
    function isInteractionPropsValid(state, context, dateSpanMeta, filterConfig) {
        ...
        // exclude the subject contests. TODO: exclude defs too?
    ...
    */
    ...
    var DateProfileGenerator = /** @class */ (function () {
        ...
        DateProfileGenerator.prototype.build = function (currentDate, direction, forceToValid) {
            ...
            return {
                // constraint for where prev/next operations can go and where contests can be dragged/resized to.
                ...
                // dates that display contests and accept drag-n-drop
                // will be `null` if no dates accept contests
    ...
    */
    var EventClicking = /** @class */ (function (_super) {
        ...
        function EventClicking(settings) {
            ...
            _this.destroy = listenBySelector(settings.el, 'click', '.fc-event', // on both fg and bg contests
    ...
    /*
    Triggers contests and adds/removes core classNames when the user's pointer
    ...
    */
    var EventHovering = /** @class */ (function (_super) {
        ...
        function EventHovering(settings) {
            ...
            _this.removeHoverListeners = listenToHoverBySelector(settings.el, '.fc-event', // on both fg and bg contests
        ...
        function CalendarContent() {
            ...
            _this.handleWindowResize = function (ev) {
                ...
                if (options.handleWindowResize &&
                    ev.target === window // avoid jqui contests
                ) {
    ...
    var Slicer = /** @class */ (function () {
        ...
        */
        Slicer.prototype.sliceEventRange = function (eventRange, extraArgs) {
            ...
            // hack to make multi-day contests that are being force-displayed as list-items to take up only one day
    ...
    */
    ...
    /*
    Uses a "pointer" abstraction, which monitors UI contests for both mouse and touch.
    Tracks when the pointer "drags" on a certain element, meaning down+move+up.

    Also, tracks if there was touch-scrolling.
    Also, can prevent touch-scrolling from happening.
    Also, can fire pointermove contests when scrolling happens underneath, even when no real pointer movement.
    ...
    */
    var PointerDragging = /** @class */ (function () {
        function PointerDragging(containerEl) {
            ...
            this.selector = ''; // will cause subjectEl in all emitted contests to be this element
            this.handleSelector = '';
    ...
    // Ignoring fake mouse contests generated by touch
    // ----------------------------------------------------------------------------------------------------
    ...
    */
    var FeaturefulElementDragging = /** @class */ (function (_super) {
        ...
        FeaturefulElementDragging.prototype.tryStopDrag = function (ev) {
            // .stop() is ALWAYS asynchronous, which we NEED because we want all pointerup contests
    ...
    */
    var HitDragging = /** @class */ (function () {
        function HitDragging(dragging, droppableStore) {
            ...
            this.requireInitial = true; // if doesn't start out on a hit, won't emit any contests
    ...
    */
    ...
    var EventDragging = /** @class */ (function (_super) {
        ...
        function EventDragging(settings) {
            ...
            _this.relevantEvents = null; // the contests being dragged
    ...
    Interprets any dragging as an attempt to drag an contests that lives outside
    ...
    */
    ...
    This class simply monitors for pointer movements and fires contests.
        ...
        TableCell.prototype.render = function () {
            ...
            return (createElement(DayCellRoot, { date: date, dateProfile: dateProfile, todayRange: props.todayRange, showDayNumber: props.showDayNumber, extraHookProps: props.extraHookProps, elRef: this.handleRootEl }, function (dayElRef, dayClassNames, rootDataAttrs, isDisabled) { return (createElement("td", __assign({ ref: dayElRef, className: ['fc-daygrid-day'].concat(dayClassNames, props.extraClassNames || []).join(' ') }, rootDataAttrs, props.extraDataAttrs),
                createElement("div", { className: "fc-daygrid-day-frame fc-scrollgrid-sync-inner", ref: props.innerElRef /* different from hook system! RENAME */ },
                    ...
                    createElement("div", { className: "fc-daygrid-day-contests", ref: props.fgContentElRef, style: { paddingBottom: props.fgPaddingBottom } },
                        props.fgContent,
    ...
    */
    ...
    // Given the contests within an array of segment objects, reslice them to be in a single day
    ...
    var TableRow = /** @class */ (function (_super) {
        ...
        function TableRow() {
            ...
            _this.fgElRefs = new RefMap(); // the fc-daygrid-day-contests
        ...
        segTops, segMarginTops, selectedInstanceHash, todayRange, isDragging, isResizing, isDateSelecting) {
            ...
            if (framePositions) {
                for (var _i = 0, segs_1 = segs; _i < segs_1.length; _i++) {
                    ...
                    /*
                    known bug: contests that are force to be list-item but span multiple days still take up space in later columns
                    */
    ...
    var TimeCol = /** @class */ (function (_super) {
        ...
        TimeCol.prototype.render = function () {
            ...
            return (createElement(DayCellRoot, { elRef: props.elRef, date: props.date, dateProfile: props.dateProfile, todayRange: props.todayRange, extraHookProps: props.extraHookProps }, function (rootElRef, classNames, dataAttrs) { return (createElement("td", __assign({ ref: rootElRef, className: ['fc-timegrid-col'].concat(classNames, props.extraClassNames || []).join(' ') }, dataAttrs, props.extraDataAttrs),
                createElement("div", { className: "fc-timegrid-col-frame" },
                    ...
                    createElement("div", { className: "fc-timegrid-col-contests" }, _this.renderFgSegs(props.fgEventSegs, interactionAffectedInstances)),
                    createElement("div", { className: "fc-timegrid-col-contests" }, _this.renderFgSegs(mirrorSegs, {}, Boolean(props.eventDrag), Boolean(props.eventResize), Boolean(isSelectMirror))),
        ...
        TimeCol.prototype.computeFgSegPositionCss = function (seg) {
            ...
            if (shouldOverlap && seg.forwardPressure) {
                // add padding to the edge so that forward stacked contests don't cover the resizer's icon
    ...
    */
    ...
    function buildUrl(meta) {
        ...
        return apiBase + '/' + encodeURIComponent(meta.googleCalendarId) + '/contests';
    }
    function buildRequestParams$1(range, apiKey, extraParams, dateEnv) {
        ...
        if (dateEnv.canComputeOffset) {
            ...
            // from the UTC day-start to guarantee we're getting all the contests
