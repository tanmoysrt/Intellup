...
(function (factory) {
    ...
    Mapael.prototype = {
        ...
        init: function () {
            ...
            // Attach delegated contests
            self.initDelegatedMapEvents();
            // Attach delegated custom contests
        ...
        /*
         * Init all delegated contests for the whole map:
         *  mouseover
         *  mousemove
         *  mouseout
         */
        ...
        /*
         * Init all delegated custom contests
         */
        initDelegatedCustomEvents: function() {
            ...
            $.each(self.customEventHandlers, function(eventName) {
                ...
                // This allow to easily unbound only custom contests and not regular ones
        ...
        /*
         * Init the element "elem" on the map (drawing text, setting attributes, contests, tooltip, ...)
         *
        ...
        onUpdateEvent: function (e, opt) {
            ...
            // Always rebind custom contests on update
            self.initDelegatedCustomEvents();
        ...
        /*
         * Set user defined handlers for contests on areas and plots
         * @param id the id of the element
         * @param type the type of the element (area, plot, link)
