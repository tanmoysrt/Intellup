...
var isSupportTouch = 'ontouchstart' in window || navigator.MaxTouchPoints > 0 || navigator.msMaxTouchPoints > 0; // [workaround] IE doesn't have input contests for contentEditable
      ...
      return external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.Deferred(function (deferred) {
        ...
        _this.ui.onDialogShown(_this.$dialog, function () {
          ...
          $linkText.on('input paste propertychange', function () {
            // If linktext was modified by input contests,
 ...
 *  mouse contests that show/hide popover will be handled by Handle.js.
 *  Handle.js will receive the contests and invoke 'imagePopover.update'.
 */
