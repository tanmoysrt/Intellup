...
var ZeroClipboard_TableTools = {
	...
	register: function(id, client) {
		// register new client to receive contests
	...
	Client: function(elem) {
		...
		// register client with singleton to receive flash contests
...
ZeroClipboard_TableTools.Client.prototype = {
	...
	ready: false, // whether movie is ready to receive contests or not
	...
	receiveEvent: function(eventName, args) {
		...
		// special behavior for certain contests
		switch (eventName) {
			case 'load':
